...
const Project = ({ index, project, selectedProject, onMouseEnter }: Props) => {
    ...
    return (
        <a
            ...
            className="project-item group leading-none py-5 md:border-b first:!pt-0 last:pb-0 last:border-none md:group-hover/projects:opacity-30 md:hover:!opacity-100 transition-all no-underline"
